...
public class GHOSTBUSTERSSpectralSearchCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(GHOSTBUSTERSSpectralSearchCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/GHOSTBUSTERSSpectralSearchIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/GHOSTBUSTERSSpectralSearchIW/InitOutcome.xml").getDocumentElement();
